...
function LandingPage() {
  ...
  useEffect(() => {
    ...
    if (userInfo) {
      axios
        ...
        .then((response) => {
          setUserPic(response.data.results[0].picture.large);
        })
        .catch((error) => {
          console.error(error);
        });
  ...
  return (
    <div className="flex items-center justify-center min-h-screen from-gray-700 via-gray-800 to-gray-900 bg-gradient-to-br">
      <div className="relative w-full group max-w-md min-w-0 mx-auto mt-20 mb-6 break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
        <div className="pb-6">
          ...
          <div className="mt-20 text-center">
            <h3 className="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">
              {userInfo ? userInfo.name : "Please Login"}
            </h3>
            ...
            <div className="w-full text-center">
              <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                <div className="flex space-x-2">
                  ...
                  <a
                    className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                    href="https://github.com/bibinmthomas"
                  ...
                  <a
                    className="p-1 -m-1 text-gray-400 hover:text-amber-500 focus:outline-none focus-visible:ring-2 ring-primary"
                    href="https://www.linkedin.com/in/bibin-mathew-thomas/"
                    rel="noreferrer"
            ...
            <div className="flex flex-wrap justify-center">
              <div className="w-full px-6">
                <p className="mb-4 font-light leading-relaxed text-gray-600 dark:text-gray-400">
                  ...
                  developing web applications using MongoDB, Express JS, React
                  JS, and Node JS. Strong knowledge of web development
                  principles and technologies including JavaScript, HTML, CSS,
                  and Git. Proven ability to work in a fast-paced environment
                  and deliver high-quality, responsive, and scalable web
                  applications.
                </p>
              </div>
              <a
                onClick={logoutHandler}
                className="cursor-pointer relative inline-flex items-center justify-center p-4 px-5 py-3 overflow-hidden font-medium text-amber-200 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-amber-400"
              >
                <span className="absolute inset-0 w-full h-full bg-gradient-to-br from-amber-600 via-amber-500 to-amber-400"></span>
                <span className="absolute bottom-0 right-0 block w-64 h-64 mb-32 mr-4 transition duration-500 origin-bottom-left transform rotate-45 translate-x-24 bg-amber-900 rounded-full opacity-30 group-hover:rotate-90 ease"></span>
